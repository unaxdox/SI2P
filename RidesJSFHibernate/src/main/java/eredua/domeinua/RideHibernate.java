...
public class RideHibernate implements Serializable {
	...
	public RideHibernate(Integer rideNumber, String from, String to, Date date, int nPlaces, float price, DriverHibernate driver) {
		super();
	...
	public RideHibernate(String from, String to,  Date date, int nPlaces, float price, DriverHibernate driver) {
		super();
		this.from = from;
		this.to = to;
		this.nPlaces = nPlaces;
